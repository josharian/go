...
func rewriteValueARM(v *Value) bool {
	shard := uint(v.Op) & 15
	return rewriteValueARM_shards[shard](v)
}

var rewriteValueARM_shards = [...]func(v *Value) bool{
	0:  rewriteValueARM_shard_0000,
	1:  rewriteValueARM_shard_0001,
	2:  rewriteValueARM_shard_0010,
	3:  rewriteValueARM_shard_0011,
	4:  rewriteValueARM_shard_0100,
	5:  rewriteValueARM_shard_0101,
	6:  rewriteValueARM_shard_0110,
	7:  rewriteValueARM_shard_0111,
	8:  rewriteValueARM_shard_1000,
	9:  rewriteValueARM_shard_1001,
	10: rewriteValueARM_shard_1010,
	11: rewriteValueARM_shard_1011,
	12: rewriteValueARM_shard_1100,
	13: rewriteValueARM_shard_1101,
	14: rewriteValueARM_shard_1110,
	15: rewriteValueARM_shard_1111,
}

func rewriteValueARM_shard_0000(v *Value) bool {
	switch v.Op {
	case OpARMADD:
...
func rewriteValueARM_shard_0001(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_0010(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_0011(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_0100(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_0101(v *Value) bool {
	switch v.Op {
	case OpARMAND:
...
func rewriteValueARM_shard_0110(v *Value) bool {
	switch v.Op {
	case OpARMANDconst:
...
func rewriteValueARM_shard_0111(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_1000(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_1001(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_1010(v *Value) bool {
	switch v.Op {
	case OpARMADDS:
...
func rewriteValueARM_shard_1011(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_1100(v *Value) bool {
	switch v.Op {
	case OpARMADC:
...
func rewriteValueARM_shard_1101(v *Value) bool {
	switch v.Op {
	case OpARMADCconst:
...
func rewriteValueARM_shard_1110(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM_shard_1111(v *Value) bool {
	switch v.Op {
