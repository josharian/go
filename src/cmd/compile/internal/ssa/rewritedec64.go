...
func rewriteValuedec64_OpLoad_0(v *Value) bool {
	...
	for {
		...
		v1 := offptr(ptr, types.Int32Ptr, 4)
		v0.AddArg(v1)
		v0.AddArg(mem)
		v.AddArg(v0)
	...
	for {
		...
		v1 := offptr(ptr, types.UInt32Ptr, 4)
		v0.AddArg(v1)
		v0.AddArg(mem)
		v.AddArg(v0)
		v2 := b.NewValue0(v.Pos, OpLoad, types.UInt32)
	...
	for {
		...
		v2 := offptr(ptr, types.UInt32Ptr, 4)
		v1.AddArg(v2)
		v1.AddArg(mem)
		v.AddArg(v1)
		return true
