...
func rewriteValuegeneric(v *Value) bool {
	...
	case OpIsInBounds:
		return rewriteValuegeneric_OpIsInBounds_0(v) || rewriteValuegeneric_OpIsInBounds_10(v) || rewriteValuegeneric_OpIsInBounds_20(v) || rewriteValuegeneric_OpIsInBounds_30(v) || rewriteValuegeneric_OpIsInBounds_40(v)
	case OpIsNonNil:
...
func rewriteValuegeneric_OpIsInBounds_20(v *Value) bool {
	...
	// cond: 0 < c && uint64( uint8(c)) <= uint64(d)
	// result: (ConstBool [1])
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		...
		d := v_1.AuxInt
		if !(0 < c && uint64(uint8(c)) <= uint64(d)) {
			break
		}
		v.reset(OpConstBool)
		v.AuxInt = 1
	...
	// cond: 0 < c && uint32( uint8(c)) <= uint32(d)
	// result: (ConstBool [1])
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		...
		d := v_1.AuxInt
		if !(0 < c && uint32(uint8(c)) <= uint32(d)) {
			break
		}
		v.reset(OpConstBool)
		v.AuxInt = 1
	...
	// cond: 0 < c && uint16( uint8(c)) <= uint16(d)
	// result: (ConstBool [1])
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		...
		d := v_1.AuxInt
		if !(0 < c && uint16(uint8(c)) <= uint16(d)) {
			break
		}
		v.reset(OpConstBool)
		v.AuxInt = 1
...
func rewriteValuegeneric_OpIsInBounds_30(v *Value) bool {
	...
	// cond: 0 < c && uint64(uint16(c)) <= uint64(d)
	// result: (ConstBool [1])
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		...
		d := v_1.AuxInt
		if !(0 < c && uint64(uint16(c)) <= uint64(d)) {
			break
		}
		v.reset(OpConstBool)
		v.AuxInt = 1
	...
	// cond: 0 < c && uint32(uint16(c)) <= uint32(d)
	// result: (ConstBool [1])
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		...
		d := v_1.AuxInt
		if !(0 < c && uint32(uint16(c)) <= uint32(d)) {
			break
		}
		v.reset(OpConstBool)
		v.AuxInt = 1
	...
	// cond: 0 < c && uint64(uint32(c)) <= uint64(d)
	// result: (ConstBool [1])
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		...
		d := v_1.AuxInt
		if !(0 < c && uint64(uint32(c)) <= uint64(d)) {
			break
		}
		v.reset(OpConstBool)
		v.AuxInt = 1
