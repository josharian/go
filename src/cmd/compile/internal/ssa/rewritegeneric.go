...
func rewriteValuegeneric_OpLoad_0(v *Value) bool {
	...
	for {
		...
		v1 := offptr(ptr, t.FieldType(0).PtrTo(), 0)
		v0.AddArg(v1)
		v0.AddArg(mem)
		v.AddArg(v0)
		return true
	...
	for {
		...
		v3 := offptr(ptr, t.FieldType(1).PtrTo(), t.FieldOff(1))
		v2.AddArg(v3)
		v2.AddArg(mem)
		v.AddArg(v2)
		return true
	...
	for {
		...
		v5 := offptr(ptr, t.FieldType(2).PtrTo(), t.FieldOff(2))
		v4.AddArg(v5)
		v4.AddArg(mem)
		v.AddArg(v4)
		return true
	...
	for {
		...
		v7 := offptr(ptr, t.FieldType(3).PtrTo(), t.FieldOff(3))
		v6.AddArg(v7)
		v6.AddArg(mem)
		v.AddArg(v6)
		return true
...
func rewriteValuegeneric_OpStore_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpStore)
		v.Aux = t.FieldType(0)
		v0 := offptr(dst, t.FieldType(0).PtrTo(), 0)
		v.AddArg(v0)
		v.AddArg(f0)
		v.AddArg(mem)
		return true
	...
	for {
		...
		v.reset(OpStore)
		v.Aux = t.FieldType(1)
		v0 := offptr(dst, t.FieldType(1).PtrTo(), t.FieldOff(1))
		v.AddArg(v0)
		v.AddArg(f1)
		v1 := b.NewValue0(v.Pos, OpStore, TypeMem)
		v1.Aux = t.FieldType(0)
		v2 := offptr(dst, t.FieldType(0).PtrTo(), 0)
		v1.AddArg(v2)
		v1.AddArg(f0)
		v1.AddArg(mem)
		v.AddArg(v1)
	...
	for {
		...
		v.reset(OpStore)
		v.Aux = t.FieldType(2)
		v0 := offptr(dst, t.FieldType(2).PtrTo(), t.FieldOff(2))
		v.AddArg(v0)
		v.AddArg(f2)
		v1 := b.NewValue0(v.Pos, OpStore, TypeMem)
		v1.Aux = t.FieldType(1)
		v2 := offptr(dst, t.FieldType(1).PtrTo(), t.FieldOff(1))
		v1.AddArg(v2)
		v1.AddArg(f1)
		v3 := b.NewValue0(v.Pos, OpStore, TypeMem)
		v3.Aux = t.FieldType(0)
		v4 := offptr(dst, t.FieldType(0).PtrTo(), 0)
		v3.AddArg(v4)
		v3.AddArg(f0)
		v3.AddArg(mem)
		v1.AddArg(v3)
	...
	for {
		...
		v.reset(OpStore)
		v.Aux = t.FieldType(3)
		v0 := offptr(dst, t.FieldType(3).PtrTo(), t.FieldOff(3))
		v.AddArg(v0)
		v.AddArg(f3)
		v1 := b.NewValue0(v.Pos, OpStore, TypeMem)
		v1.Aux = t.FieldType(2)
		v2 := offptr(dst, t.FieldType(2).PtrTo(), t.FieldOff(2))
		v1.AddArg(v2)
		v1.AddArg(f2)
		v3 := b.NewValue0(v.Pos, OpStore, TypeMem)
		v3.Aux = t.FieldType(1)
		v4 := offptr(dst, t.FieldType(1).PtrTo(), t.FieldOff(1))
		v3.AddArg(v4)
		v3.AddArg(f1)
		v5 := b.NewValue0(v.Pos, OpStore, TypeMem)
		v5.Aux = t.FieldType(0)
		v6 := offptr(dst, t.FieldType(0).PtrTo(), 0)
		v5.AddArg(v6)
		v5.AddArg(f0)
		v5.AddArg(mem)
		v3.AddArg(v5)
...
func rewriteValuegeneric_OpStructSelect_10(v *Value) bool {
	...
	for {
		...
		v.reset(OpCopy)
		v.AddArg(v0)
		v1 := offptr(ptr, v.Type.PtrTo(), t.FieldOff(int(i)))
		v0.AddArg(v1)
		v0.AddArg(mem)
		return true
	}
