...
func rewriteValueS390X_OpS390XMOVBstore_0(v *Value) bool {
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRDconst || x_1.AuxInt != 8 || w != x_1.Args[0] {
			break
		}
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRDconst || x_1.AuxInt != j+8 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRWconst || x_1.AuxInt != 8 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVBstore_10(v *Value) bool {
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRWconst || x_1.AuxInt != j+8 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		w0 := x.Args[1]
		if w0.Op != OpS390XSRDconst || w0.AuxInt != j-8 || w != w0.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		w0 := x.Args[1]
		if w0.Op != OpS390XSRWconst || w0.AuxInt != j-8 || w != w0.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVBstoreidx_0(v *Value) bool {
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRDconst || x_2.AuxInt != 8 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRDconst || x_2.AuxInt != j+8 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVBstoreidx_10(v *Value) bool {
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRWconst || x_2.AuxInt != 8 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRWconst || x_2.AuxInt != j+8 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVBstoreidx_20(v *Value) bool {
	...
	for {
		...
		mem := x.Args[3]
		if p != x.Args[0] || idx != x.Args[1] || w != x.Args[2] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		mem := x.Args[3]
		if idx != x.Args[0] || p != x.Args[1] || w != x.Args[2] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVHBRstore_0(v *Value) bool {
	...
	for {
		...
		w0 := x.Args[1]
		if w0.Op != OpS390XSRDconst || w0.AuxInt != j-16 || w != w0.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		w0 := x.Args[1]
		if w0.Op != OpS390XSRWconst || w0.AuxInt != j-16 || w != w0.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVHstore_0(v *Value) bool {
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRDconst || x_1.AuxInt != 16 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRDconst || x_1.AuxInt != j+16 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRWconst || x_1.AuxInt != 16 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVHstore_10(v *Value) bool {
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRWconst || x_1.AuxInt != j+16 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVHstoreidx_0(v *Value) bool {
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRDconst || x_2.AuxInt != 16 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRDconst || x_2.AuxInt != j+16 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVHstoreidx_10(v *Value) bool {
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRWconst || x_2.AuxInt != 16 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRWconst || x_2.AuxInt != j+16 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVWBRstore_0(v *Value) bool {
	...
	for {
		...
		w0 := x.Args[1]
		if w0.Op != OpS390XSRDconst || w0.AuxInt != j-32 || w != w0.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVWstore_0(v *Value) bool {
	...
	for {
		...
		x_1 := x.Args[1]
		if x_1.Op != OpS390XSRDconst || x_1.AuxInt != j+32 || w != x_1.Args[0] {
			break
		}
		if !(p.Op != OpSB && x.Uses == 1 && clobber(x)) {
			break
...
func rewriteValueS390X_OpS390XMOVWstoreidx_0(v *Value) bool {
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRDconst || x_2.AuxInt != 32 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
	...
	for {
		...
		x_2 := x.Args[2]
		if x_2.Op != OpS390XSRDconst || x_2.AuxInt != j+32 || w != x_2.Args[0] {
			break
		}
		if !(x.Uses == 1 && clobber(x)) {
			break
...
func rewriteBlockS390X(b *Block) bool {
	...
	case BlockS390XNE:
		...
		for {
			v := b.Control
			if v.Op != OpS390XCMPWconst || v.AuxInt != 0 {
				break
			}
			v_0 := v.Args[0]
