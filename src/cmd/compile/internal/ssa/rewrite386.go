...
func rewriteValue386(v *Value) bool {
	shard := uint(v.Op) & 15
	return rewriteValue386_shards[shard](v)
}

var rewriteValue386_shards = [...]func(v *Value) bool{
	0:  rewriteValue386_shard_0000,
	1:  rewriteValue386_shard_0001,
	2:  rewriteValue386_shard_0010,
	3:  rewriteValue386_shard_0011,
	4:  rewriteValue386_shard_0100,
	5:  rewriteValue386_shard_0101,
	6:  rewriteValue386_shard_0110,
	7:  rewriteValue386_shard_0111,
	8:  rewriteValue386_shard_1000,
	9:  rewriteValue386_shard_1001,
	10: rewriteValue386_shard_1010,
	11: rewriteValue386_shard_1011,
	12: rewriteValue386_shard_1100,
	13: rewriteValue386_shard_1101,
	14: rewriteValue386_shard_1110,
	15: rewriteValue386_shard_1111,
}

func rewriteValue386_shard_0000(v *Value) bool {
	switch v.Op {
	case Op386ADDLconst:
...
func rewriteValue386_shard_0001(v *Value) bool {
	switch v.Op {
	case Op386ADDLcarry:
...
func rewriteValue386_shard_0010(v *Value) bool {
	switch v.Op {
...
func rewriteValue386_shard_0011(v *Value) bool {
	switch v.Op {
	case Op386ADCL:
...
func rewriteValue386_shard_0100(v *Value) bool {
	switch v.Op {
...
func rewriteValue386_shard_0101(v *Value) bool {
	switch v.Op {
	case Op386ADDLload:
...
func rewriteValue386_shard_0110(v *Value) bool {
	switch v.Op {
...
func rewriteValue386_shard_0111(v *Value) bool {
	switch v.Op {
	case Op386ADDSSload:
...
func rewriteValue386_shard_1000(v *Value) bool {
	switch v.Op {
	case Op386ADDSDload:
...
func rewriteValue386_shard_1001(v *Value) bool {
	switch v.Op {
...
func rewriteValue386_shard_1010(v *Value) bool {
	switch v.Op {
	case Op386ANDL:
...
func rewriteValue386_shard_1011(v *Value) bool {
	switch v.Op {
...
func rewriteValue386_shard_1100(v *Value) bool {
	switch v.Op {
	case Op386MOVBLZX:
...
func rewriteValue386_shard_1101(v *Value) bool {
	switch v.Op {
	case Op386DIVSSload:
...
func rewriteValue386_shard_1110(v *Value) bool {
	switch v.Op {
...
func rewriteValue386_shard_1111(v *Value) bool {
	switch v.Op {
	case Op386ADDL:
