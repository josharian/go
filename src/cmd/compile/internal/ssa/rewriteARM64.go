...
func rewriteValueARM64(v *Value) bool {
	shard := uint(v.Op) & 15
	return rewriteValueARM64_shards[shard](v)
}

var rewriteValueARM64_shards = [...]func(v *Value) bool{
	0:  rewriteValueARM64_shard_0000,
	1:  rewriteValueARM64_shard_0001,
	2:  rewriteValueARM64_shard_0010,
	3:  rewriteValueARM64_shard_0011,
	4:  rewriteValueARM64_shard_0100,
	5:  rewriteValueARM64_shard_0101,
	6:  rewriteValueARM64_shard_0110,
	7:  rewriteValueARM64_shard_0111,
	8:  rewriteValueARM64_shard_1000,
	9:  rewriteValueARM64_shard_1001,
	10: rewriteValueARM64_shard_1010,
	11: rewriteValueARM64_shard_1011,
	12: rewriteValueARM64_shard_1100,
	13: rewriteValueARM64_shard_1101,
	14: rewriteValueARM64_shard_1110,
	15: rewriteValueARM64_shard_1111,
}

func rewriteValueARM64_shard_0000(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_0001(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_0010(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_0011(v *Value) bool {
	switch v.Op {
	case OpARM64CMP:
...
func rewriteValueARM64_shard_0100(v *Value) bool {
	switch v.Op {
	case OpARM64BIC:
...
func rewriteValueARM64_shard_0101(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_0110(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_0111(v *Value) bool {
	switch v.Op {
	case OpARM64CMN:
...
func rewriteValueARM64_shard_1000(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_1001(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_1010(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_1011(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_1100(v *Value) bool {
	switch v.Op {
	case OpARM64ADD:
...
func rewriteValueARM64_shard_1101(v *Value) bool {
	switch v.Op {
...
func rewriteValueARM64_shard_1110(v *Value) bool {
	switch v.Op {
	case OpARM64AND:
...
func rewriteValueARM64_shard_1111(v *Value) bool {
	switch v.Op {
