...
func rewriteValueMIPS64(v *Value) bool {
	shard := uint(v.Op) & 15
	return rewriteValueMIPS64_shards[shard](v)
}

var rewriteValueMIPS64_shards = [...]func(v *Value) bool{
	0:  rewriteValueMIPS64_shard_0000,
	1:  rewriteValueMIPS64_shard_0001,
	2:  rewriteValueMIPS64_shard_0010,
	3:  rewriteValueMIPS64_shard_0011,
	4:  rewriteValueMIPS64_shard_0100,
	5:  rewriteValueMIPS64_shard_0101,
	6:  rewriteValueMIPS64_shard_0110,
	7:  rewriteValueMIPS64_shard_0111,
	8:  rewriteValueMIPS64_shard_1000,
	9:  rewriteValueMIPS64_shard_1001,
	10: rewriteValueMIPS64_shard_1010,
	11: rewriteValueMIPS64_shard_1011,
	12: rewriteValueMIPS64_shard_1100,
	13: rewriteValueMIPS64_shard_1101,
	14: rewriteValueMIPS64_shard_1110,
	15: rewriteValueMIPS64_shard_1111,
}

func rewriteValueMIPS64_shard_0000(v *Value) bool {
	switch v.Op {
...
func rewriteValueMIPS64_shard_0001(v *Value) bool {
	switch v.Op {
	case OpConstBool:
...
func rewriteValueMIPS64_shard_0010(v *Value) bool {
	switch v.Op {
...
func rewriteValueMIPS64_shard_0011(v *Value) bool {
	switch v.Op {
...
func rewriteValueMIPS64_shard_0100(v *Value) bool {
	switch v.Op {
...
func rewriteValueMIPS64_shard_0101(v *Value) bool {
	switch v.Op {
	case OpAdd8:
...
func rewriteValueMIPS64_shard_0110(v *Value) bool {
	switch v.Op {
	case OpAdd16:
...
func rewriteValueMIPS64_shard_0111(v *Value) bool {
	switch v.Op {
	case OpAdd32:
...
func rewriteValueMIPS64_shard_1000(v *Value) bool {
	switch v.Op {
	case OpAdd64:
...
func rewriteValueMIPS64_shard_1001(v *Value) bool {
	switch v.Op {
	case OpAddPtr:
...
func rewriteValueMIPS64_shard_1010(v *Value) bool {
	switch v.Op {
	case OpAdd32F:
...
func rewriteValueMIPS64_shard_1011(v *Value) bool {
	switch v.Op {
	case OpAdd64F:
...
func rewriteValueMIPS64_shard_1100(v *Value) bool {
	switch v.Op {
	case OpDiv64u:
...
func rewriteValueMIPS64_shard_1101(v *Value) bool {
	switch v.Op {
	case OpAndB:
...
func rewriteValueMIPS64_shard_1110(v *Value) bool {
	switch v.Op {
	case OpAddr:
...
func rewriteValueMIPS64_shard_1111(v *Value) bool {
	switch v.Op {
	case OpAtomicLoad64:
