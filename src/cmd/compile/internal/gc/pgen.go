...
var (
	...
	needscompile    []*Node // functions waiting to be compiled
)
...
// they are enqueued in needscompile,
// which is drained by finishcompilation.
...
// finishcompilation compiles all functions in needscompile.
