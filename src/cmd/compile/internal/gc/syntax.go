...
const (
	...
	OCALLFUNC        // Left(List⁀Rlist) (function call f(args))
	OCALLMETH        // Left(List⁀Rlist) (direct method call x.Method(args))
	OCALLINTER       // Left(List⁀Rlist) (interface method call x.Method(args))
