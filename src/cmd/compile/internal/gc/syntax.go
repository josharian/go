...
const (
	...
	OCALLFUNC        // Left(List; Rlist) (function call: f(List) before walk, eval(List); f(Rlist) after walk))
	OCALLMETH        // Left(List; Rlist) (direct method call x.Method(args), same structure as OCALLFUNC)
	OCALLINTER       // Left(List; Rlist) (interface method call x.Method(args), same structure as OCALLFUNC)
