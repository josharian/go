...
func wbelse(dstp unsafe.Pointer, src unsafe.Pointer) {
	// return
	if goexitPC == 0 {
		return
	}
	dst := *(*unsafe.Pointer)(dstp)
	if dst == src && fastrandn(10) == 1 /*&& src == nil */ {
		lock(&tracelock)
		gp := getg()
		gp.m.traceback = 2
		print("nil=", src == nil, " ")
		// goroutineheader(gp)
		pc := getcallerpc()
		sp := getcallersp(unsafe.Pointer(&dstp))
		systemstack(func() {
			traceback1(pc, sp, 0, gp, _TraceTop)
		})
		// print("\n")
		gp.m.traceback = 0
		unlock(&tracelock)
...
pretty much reached the end of that

18:21:22 ~/go/tip/src (wbeqhack)$ m 2>&1 | pct -n 20
  5.40% 19229 nil=false 	/Users/josh/go/tip/src/runtime/panic.go:292
  5.39% 19209 nil=false 	/Users/josh/go/tip/src/runtime/panic.go:92
  5.38% 19177 nil=true 	/Users/josh/go/tip/src/runtime/panic.go:215
  5.37% 19142 nil=true 	/Users/josh/go/tip/src/runtime/panic.go:347
  5.37% 19141 nil=false 	/Users/josh/go/tip/src/runtime/panic.go:230
  2.86% 10171 nil=false 	/Users/josh/go/tip/src/runtime/panic.go:228
  2.84% 10110 nil=false 	/Users/josh/go/tip/src/runtime/panic.go:348
  2.80%  9960 nil=true 	/Users/josh/go/tip/src/runtime/panic.go:289
  2.57%  9156 nil=true 	/Users/josh/go/tip/src/runtime/panic.go:348
  2.55%  9084 nil=false 	/Users/josh/go/tip/src/debug/macho/file.go:474
  1.81%  6440 nil=false 	/Users/josh/go/tip/src/runtime/map_faststr.go:269
  1.72%  6137 nil=false 	/Users/josh/go/tip/src/cmd/compile/internal/gc/subr.go:327
  1.34%  4765 nil=false 	<autogenerated>:1
  1.34%  4755 nil=true 	/Users/josh/go/tip/src/cmd/compile/internal/gc/typecheck.go:205
  1.32%  4719 nil=false 	/Users/josh/go/tip/src/cmd/compile/internal/gc/typecheck.go:199
  1.32%  4719 nil=false 	/Users/josh/go/tip/src/go/parser/parser.go:257
  1.15%  4092 nil=false 	/Users/josh/go/tip/src/runtime/proc.go:2271
  1.12%  3984 nil=false 	/Users/josh/go/tip/src/runtime/proc.go:2270
  1.12%  3976 nil=false 	/Users/josh/go/tip/src/runtime/map_faststr.go:402
  1.09%  3871 nil=false 	/Users/josh/go/tip/src/cmd/compile/internal/gc/syntax.go:179
18:22:45 ~/go/tip/src (wbeqhack *)$
